  ...
  return (
    <Container size="lg" py="xl">
      <Stack gap="xl" align="center" py={80}>
        ...
        <Title
          order={1}
          style={{ fontSize: rem(48), fontWeight: 900, textAlign: "center" }}
        >
          Automate Your Gherkin{" "}
          <Text
            span
            inherit
            variant="gradient"
        ...
        <Text c="dimmed" size="xl" maw={600} ta="center">
          Turn any website into a comprehensive suite of Gherkin scenarios
          instantly. Powered by Agentic AI to understand your application's
          behavior.
        </Text>
...
function FeatureCard({
  ...
  return (
    <Card shadow="sm" padding="lg" radius="md" withBorder>
      <Card.Section>{/* Image or visual could go here */}</Card.Section>
